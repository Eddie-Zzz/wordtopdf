package com.company.word.docx.convert;
...
public class SetDocxStyle {

    //向word中写入数据-操作相关样式说明

    /**
     * 有些方法需要传特殊类型的参数的时候，一般可以用★静态的接口.参数★来传参
     * *@parampath49 *@paramdata50
     * */
    public static void writeDataDocx(String path,String data,boolean jiacu,int size){
        ...
        try{
            ...
            r1.setFontSize(size);//---字体大小103 //r1.setImprinted(true);//感觉与setEmbossed(true)类似，有重影
